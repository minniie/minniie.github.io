...
- discrete random variables: bernoulli, binomial, categorical, multinomial
    - <span style="color:#872657; font-weight:bold;">bernoulli distribution (베르누이분포):</span>
    ...
    - <span style="color:#872657; font-weight:bold;">binomial distribution (이항분포):</span>
    ...
    - <span style="color:#872657; font-weight:bold;">categorial distribution (카테고리분포):</span>
    ...
    - <span style="color:#872657; font-weight:bold;">multinomial distribution (다항분포):</span>
...
- continuous random variables: gaussian, beta, dirichlet
    - <span style="color:#872657; font-weight:bold;">gaussian/normal distribution (가우시안분포/정규분포):</span>
